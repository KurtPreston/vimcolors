...
call s:highlight('CursorLine',   { 'bg': s:LIGHT_GREY                })
...
call s:link('String', 'Normal')

call s:link('Identifier', 'Normal')
call s:link('Function', 'Identifier')

call s:highlight('PreProc', {'bg': s:BLACK, 'fg': s:LIGHT_GREEN})
...
call s:highlight('Statement', {'bg': s:BLACK, 'fg': s:LIGHT_GREEN})
...
call s:highlight('Type', {'bg': s:BLACK, 'fg': s:LIGHT_GREEN})
