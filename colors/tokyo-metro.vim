...
function! s:create_context() abort
  let p = tokyometro#palette#dark#create()
  let c = p.cterm
  let g = p.gui
  ...
  call extend(rules, pgmnt#hi#group(
        \ 'DiffAdd', {
        \   'ctermbg': c.yurakucho_tint_bg,
        \   'ctermfg': c.yurakucho_tint_fg,
        \   'guibg': g.yurakucho_tint_bg,
        \   'guifg': g.yurakucho_tint_fg,
        \ }))
  call extend(rules, pgmnt#hi#group(
        \ 'DiffChange', {
        \   'ctermbg': c.tozai_tint_bg,
        \   'ctermfg': c.tozai_tint_fg,
        \   'guibg': g.tozai_tint_bg,
        \   'guifg': g.tozai_tint_fg,
        \ }))
  call extend(rules, pgmnt#hi#group(
        \ 'DiffDelete', {
        \   'ctermbg': c.marunouchi_tint_bg,
        \   'ctermfg': c.marunouchi_tint_fg,
        \   'guibg': g.marunouchi_tint_bg,
        \   'guifg': g.marunouchi_tint_fg,
        \ }))
  call extend(rules, pgmnt#hi#group(
        \ 'DiffText', {
        \   'cterm': 'NONE',
        ...
        \   'ctermfg': 195,
        \   'gui': 'NONE',
        \   'guibg': pgmnt#color#mix(g.tozai, g.normal_bg, 0.6),
        \   'guifg': g.normal_fg,
        \ }))
  call extend(rules, pgmnt#hi#group(
        \ 'Directory', {
  ...
  let term_colors = [
        ...
        \   g.normal_fg,
        \   g.comment_fg,
        \   pgmnt#color#adjust_color(g.marunouchi,       {'saturation': +0.05, 'lightness': +0.05}),
        \   pgmnt#color#adjust_color(g.yurakucho,     {'saturation': +0.05, 'lightness': +0.05}),
        \   pgmnt#color#adjust_color(g.ginza,    {'saturation': +0.05, 'lightness': +0.05}),
        \   pgmnt#color#adjust_color(g.chiyoda,      {'saturation': +0.05, 'lightness': +0.05}),
        \   pgmnt#color#adjust_color(g.hanzomon,    {'saturation': +0.05, 'lightness': +0.05}),
        \   pgmnt#color#adjust_color(g.tozai,     {'saturation': +0.05, 'lightness': +0.05}),
