...
" Website:      https://github.com/sainnhe/neon/
" License:      MIT && Anti-996
" Last Updated: Tue 17 Dec 2019 11:57:48 AM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#bcc3d2', '#f07e7e', '#a4be8e', '#d0b073',
          \ '#7eb4e7', '#d898eb', '#7bbbb5', '#88909f', '#bcc3d2', '#f07e7e',
          \ '#a4be8e', '#d0b073', '#7eb4e7', '#d898eb', '#7bbbb5', '#88909f']
    if has('nvim')
      let g:terminal_color_0 = '#bcc3d2'
      ...
      let g:terminal_color_6 = '#7bbbb5'
      let g:terminal_color_7 = '#88909f'
      let g:terminal_color_8 = '#bcc3d2'
      ...
      let g:terminal_color_14 = '#7bbbb5'
      let g:terminal_color_15 = '#88909f'
    endif
    hi Fg guifg=#bcc3d2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi Cyan guifg=#7bbbb5 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    if get(g:, 'neon_transparent_background', 0) && !has('gui_running')
      hi Normal guifg=#bcc3d2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      hi Terminal guifg=#bcc3d2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
      ...
      hi Normal guifg=#bcc3d2 guibg=#23252e guisp=NONE gui=NONE cterm=NONE
      hi Terminal guifg=#bcc3d2 guibg=#23252e guisp=NONE gui=NONE cterm=NONE
    ...
    if &rnu == 1 && &cul == 0
      hi CursorLineNr guifg=#bcc3d2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    else
      hi CursorLineNr guifg=#bcc3d2 guibg=#272935 guisp=NONE gui=NONE cterm=NONE
    endif
    ...
    hi ModeMsg guifg=#bcc3d2 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi Pmenu guifg=#bcc3d2 guibg=#333749 guisp=NONE gui=NONE cterm=NONE
    hi PmenuSbar guifg=NONE guibg=#333749 guisp=NONE gui=NONE cterm=NONE
    if get(g:, 'neon_popup_menu_selection_background', 'blue') ==# 'blue'
    ...
    elseif get(g:, 'neon_popup_menu_selection_background', 'green') ==# 'green'
    ...
    elseif get(g:, 'neon_popup_menu_selection_background', 'purple') ==# 'purple'
    ...
    hi StatusLine guifg=#bcc3d2 guibg=#393e53 guisp=NONE gui=NONE cterm=NONE
    hi StatusLineTerm guifg=#bcc3d2 guibg=#393e53 guisp=NONE gui=NONE cterm=NONE
    ...
    hi TabLine guifg=#bcc3d2 guibg=#393e53 guisp=NONE gui=NONE cterm=NONE
    ...
    hi CursorIM guifg=NONE guibg=#bcc3d2 guisp=NONE gui=NONE cterm=NONE
    hi ToolbarLine guifg=NONE guibg=#88909f guisp=NONE gui=NONE cterm=NONE
    hi ToolbarButton guifg=#bcc3d2 guibg=#23252e guisp=NONE gui=bold cterm=bold
    ...
    hi Identifier guifg=#7bbbb5 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Constant guifg=#7bbbb5 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi Delimiter guifg=#bcc3d2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    if !s:italics
      hi VisualNOS gui=NONE cterm=NONE
      hi Todo gui=NONE cterm=NONE
    endif
    if get(g:, 'neon_disable_italic_comment', 0)
    ...
    if get(g:, 'neon_transparent_background', 0)
      ...
      hi GitGutterDelete guifg=#f07e7e guibg=#2b2d3a guisp=NONE gui=NONE cterm=NONE
    ...
    hi Lf_hl_match1 guifg=#7bbbb5 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi deniteStatusLinePath guifg=#bcc3d2 guibg=#2b2d3a guisp=NONE gui=NONE cterm=NONE
    ...
    if get(g:, 'neon_transparent_background', 0)
      ...
      hi ALEErrorSign guifg=#f07e7e guibg=#2b2d3a guisp=NONE gui=NONE cterm=NONE
    ...
    if get(g:, 'neon_current_word', get(g:, 'neon_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'bold'
      hi CocHighlightText guifg=NONE guibg=NONE guisp=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
    elseif get(g:, 'neon_current_word', get(g:, 'neon_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'underline'
      hi CocHighlightText guifg=NONE guibg=NONE guisp=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
    elseif get(g:, 'neon_current_word', get(g:, 'neon_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'italic'
    ...
    elseif get(g:, 'neon_current_word', get(g:, 'neon_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'grey background'
    ...
    if get(g:, 'neon_transparent_background', 0)
      hi CocHintSign guifg=#7bbbb5 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    else
      hi CocHintSign guifg=#7bbbb5 guibg=#2b2d3a guisp=NONE gui=NONE cterm=NONE
    endif
    ...
    hi markdownH5 guifg=#7bbbb5 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi htmlH5 guifg=#7bbbb5 guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi helpURL guifg=#7bbbb5 guibg=NONE guisp=NONE gui=underline cterm=underline
  ...
  if get(g:, 'neon_transparent_background', 0) && !has('gui_running')
    ...
    hi FoldColumn guifg=#949ba5 guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
    hi Folded guifg=#949ba5 guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
    hi SignColumn guifg=NONE guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
  endif
  hi ColorColumn guifg=NONE guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
  ...
  hi Search guifg=NONE guibg=#e5eaf0 guisp=NONE gui=NONE cterm=NONE
  hi MatchParen guifg=NONE guibg=#dde4ea guisp=NONE gui=NONE cterm=NONE
  hi NonText guifg=#949ba5 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Pmenu guifg=#4b505b guibg=#e7ecf1 guisp=NONE gui=NONE cterm=NONE
  hi PmenuSbar guifg=NONE guibg=#e7ecf1 guisp=NONE gui=NONE cterm=NONE
  if get(g:, 'neon_popup_menu_selection_background', 'blue') ==# 'blue'
  ...
  hi PmenuThumb guifg=NONE guibg=#bbc7d3 guisp=NONE gui=NONE cterm=NONE
  ...
  hi StatusLine guifg=#4b505b guibg=#dde4ea guisp=NONE gui=NONE cterm=NONE
  hi StatusLineTerm guifg=#4b505b guibg=#dde4ea guisp=NONE gui=NONE cterm=NONE
  hi StatusLineNC guifg=#949ba5 guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
  hi StatusLineTermNC guifg=#949ba5 guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
  hi TabLine guifg=#4b505b guibg=#dde4ea guisp=NONE gui=NONE cterm=NONE
  hi TabLineFill guifg=#949ba5 guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#fafafa guibg=#bf75d6 guisp=NONE gui=NONE cterm=NONE
  hi VertSplit guifg=#dde4ea guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Visual guifg=NONE guibg=#e5eaf0 guisp=NONE gui=NONE cterm=NONE
  hi VisualNOS guifg=NONE guibg=#e5eaf0 guisp=NONE gui=italic cterm=italic
  ...
  hi QuickFixLine guifg=#5079be guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
  ...
  if get(g:, 'neon_transparent_background', 0)
    ...
    hi GitGutterAdd guifg=#608e32 guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
    hi GitGutterChange guifg=#5079be guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
    hi GitGutterDelete guifg=#d15f5f guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
    hi GitGutterChangeDelete guifg=#b05ccc guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
  endif
  if get(g:, 'neon_transparent_background', 0)
    ...
    hi SignatureMarkText guifg=#5079be guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
    hi SignatureMarkerText guifg=#b05ccc guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
  endif
  hi CtrlPMatch guifg=#608e32 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi CtrlPPrtBase guifg=#bbc7d3 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi CtrlPLinePre guifg=#bbc7d3 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi CtrlPMode1 guifg=#5079be guibg=#eef2f6 guisp=NONE gui=bold cterm=bold
  hi CtrlPMode2 guifg=#eef2f6 guibg=#5079be guisp=NONE gui=bold cterm=bold
  hi CtrlPStats guifg=#949ba5 guibg=#eef2f6 guisp=NONE gui=bold cterm=bold
  ...
  hi deniteInput guifg=#608e32 guibg=#eef2f6 guisp=NONE gui=bold cterm=bold
  hi deniteStatusLineNumber guifg=#b05ccc guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
  hi deniteStatusLinePath guifg=#4b505b guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
  ...
  if get(g:, 'neon_transparent_background', 0)
    ...
    hi ALEErrorSign guifg=#d15f5f guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
    hi ALEWarningSign guifg=#be7e05 guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
    hi ALEInfoSign guifg=#5079be guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
  endif
  if get(g:, 'neon_current_word', get(g:, 'neon_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'bold'
    hi CocHighlightText guifg=NONE guibg=NONE guisp=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
  elseif get(g:, 'neon_current_word', get(g:, 'neon_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'underline'
  ...
  elseif get(g:, 'neon_current_word', get(g:, 'neon_transparent_background', 0) == 0 ? 'grey background' : 'bold') ==# 'grey background'
    hi CocHighlightText guifg=NONE guibg=#e7ecf1 guisp=NONE gui=NONE cterm=NONE
  endif
  hi CocHoverRange guifg=NONE guibg=NONE guisp=NONE gui=bold,underline ctermfg=NONE ctermbg=NONE cterm=bold,underline
  if get(g:, 'neon_transparent_background', 0)
    hi CocHintSign guifg=#3a8b84 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
    hi CocHintSign guifg=#3a8b84 guibg=#eef2f6 guisp=NONE gui=NONE cterm=NONE
  endif
  hi MatchParenCur guifg=NONE guibg=NONE guisp=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
  hi MatchWord guifg=NONE guibg=NONE guisp=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
  hi MatchWordCur guifg=NONE guibg=NONE guisp=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
...
" Color: background_col #eef2f6          ~                 LightGrey
" Color: background_pmenu #e7ecf1        ~                 LightGrey
" Color: background_sign #dde4ea         ~                 LightGrey
" Color: background_visual #e5eaf0       ~                 LightGrey
" Color: background_grey #bbc7d3         ~                 LightGrey
